...
<!-- 								<c:if test="${adspace.status==1}"><a href="javascript:changStatus(${adspace.id},0)">禁用</a></c:if> -->
								...
								<a href="${contextPath}/adspace/conf?id=${adspace.id}&appClientId=${adspace.appClientId}&version=${adspace.appClientVersion}&adspaceNum=${adspace.adSpaceNumber}&curPage=1">查看配置详情</a>
							</td>
						</tr>
					</c:forEach>
				</table>
